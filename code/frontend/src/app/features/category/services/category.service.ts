...
/** Bộ lọc xuất file Category — khớp với CreateExportCategoryJobRequestDTO.java */
export interface CategoryExportFilter {
  paramType?: string;
  paramValue?: string;
  paramName?: string;
  status?: number[];
...
export class CategoryService extends BaseFeatureService {
   ...
   */
  createExportJob(filters: CategoryExportFilter = {}): Observable<ApiResponse<ExportJobResponse>> {
