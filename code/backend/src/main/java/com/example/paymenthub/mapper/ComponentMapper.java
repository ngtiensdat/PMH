...
public interface ComponentMapper {
    ...
    @Mapping(target = "isActive", expression = "java(com.example.paymenthub.service.impl.ComponentServiceImpl.computeActiveStatus(dto.getEffectiveDate(), dto.getEndEffectiveDate()))")
